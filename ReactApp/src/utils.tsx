...
import CustomerFeedback from "./components/widgets/CustomerFeedback";
import CustomerRatings from "./components/widgets/CustomerRatings";
import DeviceHealth from "./components/widgets/DeviceHealth";
